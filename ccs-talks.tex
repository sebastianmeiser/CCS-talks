...
\section{Cyberphysical Systems: Scission: Signal Characteristic-based sender identification and intrusion detection in automotive networks}
...
\section{Detecting Attacks Against Robotic Vehicles: A Control Invariant Approach}
